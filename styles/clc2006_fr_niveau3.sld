  ...
  <NamedLayer>
    ...
    <UserStyle>
      ...
      <se:FeatureTypeStyle>
        ...
        <se:Rule>
          <se:Name>121  Zones industrielles ou commerciales</se:Name>
          <se:Description>
            <se:Title>121  Zones industrielles ou commerciales</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>code_06</ogc:PropertyName>
        ...
        <se:Rule>
          ...
          <se:Description>
            ...
            <se:Abstract>132 Décharges</se:Abstract>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>code_06</ogc:PropertyName>
        ...
        <se:Rule>
          <se:Name>142  Équipements sportifs et de loisirs</se:Name>
          <se:Description>
            <se:Title>142  Équipements sportifs et de loisirs</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>code_06</ogc:PropertyName>
        ...
        <se:Rule>
          <se:Name>231 Prairies</se:Name>
          <se:Description>
            <se:Title>231 Prairies</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>code_06</ogc:PropertyName>
        ...
        <se:Rule>
          <se:Name>241 Cultures annuelles associées aux cultures permanentes</se:Name>
          <se:Description>
            <se:Title>241 Cultures annuelles associées aux cultures permanentes</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>code_06</ogc:PropertyName>
        ...
        <se:Rule>
          <se:Name>244 Territoires agro-forestiers</se:Name>
          <se:Description>
            <se:Title>244 Territoires agro-forestiers</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>code_06</ogc:PropertyName>
        ...
        <se:Rule>
          <se:Name>324  Forêts et végétation arbustive en mutation</se:Name>
          <se:Description>
            <se:Title>324  Forêts et végétation arbustive en mutation</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>code_06</ogc:PropertyName>
        ...
        <se:Rule>
          ...
          <se:PolygonSymbolizer>
            <se:Fill>
              <se:SvgParameter name="fill">#195798</se:SvgParameter>
            </se:Fill>
          </se:PolygonSymbolizer>
        </se:Rule>
        <se:Rule>
